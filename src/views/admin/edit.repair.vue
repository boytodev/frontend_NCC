...
onMounted(async () => {
    try {
        const apiURL = `https://ncc-api.ncc-computerrepair.com/api-repair/edit-repair/${route.params.id}`;
...
const updateData = async () => {
    try {
        const apiURL = `https://ncc-api.ncc-computerrepair.com/api-repair/update-repair/${route.params.id}`;
